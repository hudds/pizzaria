...
<tags:pageTemplate title="Pedidos Enviados" css="home.css">
	<form>
		<input id="change-state-to" type="hidden" value="CONCLUIDO"/>
		<input id="estado-pedido" type="hidden" value="ENVIADO"/>
	</form>
		...
		<template id="template-pedido">
			<li class="list-group-item">
				<div class="border rounded p-3">
					...
					<button class="btn btn-danger button-muda-estado">Mudar para concluído</button>
				</div>
			</li>
		</template>
