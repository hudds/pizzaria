...
<tags:pageTemplate title="Pedidos Em Preparo" css="home.css">
	<form>
		<input id="change-state-to" type="hidden" value="ENVIADO"/>
		<input id="estado-pedido" type="hidden" value="PREPARANDO"/>
	</form>
		...
		<template id="template-pedido">
			<li class="list-group-item">
				<div class="border rounded p-3">
					...
					<button class="btn btn-danger button-muda-estado">Mudar para enviado</button>
				</div>
			</li>
		</template>
